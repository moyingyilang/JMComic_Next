...
public final class FragmentBannerBinding implements ViewBinding {
  ...
  private FragmentBannerBinding(@NonNull FrameLayout rootView, @NonNull LinearLayout llIndicator,
  ...
  public static FragmentBannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.llIndicator;
      LinearLayout llIndicator = ViewBindings.findChildViewById(rootView, id);
      if (llIndicator == null) {
        break missingId;
      }
      ...
      return new FragmentBannerBinding((FrameLayout) rootView, llIndicator, viewPagerBanner);
    }
